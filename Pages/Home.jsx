    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap md:flex-nowrap items-center justify-between gap-4 py-3 md:py-0 md:h-16">
            {/* Logo */}
            <Link to="/" className="flex items-center space-x-1 group order-1">
              <span className="text-xl sm:text-2xl font-bold text-gray-900 group-hover:text-yellow-500 transition-colors duration-300">
                Velmora
              </span>
            ...
            <button className="md:hidden order-3 p-2 rounded-lg hover:bg-gray-100">
            ...
            <div className="w-full md:flex-1 md:max-w-2xl order-4 md:order-2 mt-3 md:mt-0">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 sm:px-5 py-2 text-sm sm:text-base border border-gray-300 rounded-full focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 transition-all duration-300"
                />
                <button className="absolute right-1 top-1/2 -translate-y-1/2 bg-yellow-500 text-white px-4 sm:px-6 py-1 text-sm sm:text-base rounded-full hover:bg-yellow-600 transition-colors duration-300 font-medium">
                  Search
                </button>
              </div>
            </div>

            {/* Nav Icons - Scrollable on mobile */}
            <div className="flex items-center gap-3 sm:gap-4 md:gap-6 order-2 md:order-3 overflow-x-auto pb-1 md:pb-0">
              <Link to="/order" className="flex flex-col items-center text-gray-700 hover:text-yellow-500 transition-colors duration-300 group flex-shrink-0">
              ...
              <Link to="/wishlist" className="flex flex-col items-center text-gray-700 hover:text-yellow-500 transition-colors duration-300 group flex-shrink-0">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link to="/cart" className="flex flex-col items-center text-gray-700 hover:text-yellow-500 transition-colors duration-300 group relative flex-shrink-0">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <circle cx="9" cy="21" r="1" />
                  <circle cx="20" cy="21" r="1" />
                  <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" />
                </svg>
                <span className="absolute -top-2 -right-2 bg-yellow-500 text-white text-[10px] rounded-full w-3.5 h-3.5 sm:w-4 sm:h-4 flex items-center justify-center font-bold">
                  3
                </span>
              ...
              {!token ? (
                <Link to="/login" className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-3 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm rounded-full hover:from-yellow-500 hover:to-yellow-600 transition-all duration-300 font-medium shadow-md hover:shadow-lg whitespace-nowrap flex-shrink-0">
                  Login
                </Link>
              ) : (
                <Link to="/profile" className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-3 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm rounded-full hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg whitespace-nowrap flex-shrink-0">
                  Profile
                </Link>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative order-1 lg:order-2 max-w-md mx-auto lg:max-w-none">
              <div className="w-full aspect-square rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1740664651822-3a02ec12c121?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBzaG9wcGluZyUyMGVjb21tZXJjZSUyMGJhbm5lcnxlbnwxfHx8fDE3NzI4MTc0NDR8MA&ixlib=rb-4.1.0&q=80&w=1080"
...
const ReviewCard = ({ name, role, image, comment, rating }) => (
  <div className="bg-gray-50 rounded-lg sm:rounded-xl p-5 sm:p-6 md:p-8 shadow-sm hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 relative">
    <div className="absolute top-4 sm:top-6 right-4 sm:right-6 opacity-20 text-yellow-500">
      <svg width="32" height="32" sm:width="40" sm:height="40" md:width="48" md:height="48" viewBox="0 0 24 24" fill="currentColor">
